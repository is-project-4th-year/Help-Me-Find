...
<body>
  ...
  {{-- UPDATED: Removed inline styles, added classes --}}
  <div class="container home-container">
    <div class="space-y-6">

        <div class="text-center space-y-2 welcome-header-wrapper">
        ...
        <div class="home-grid-container">
            ...
            <div class="grid-col-main">
                <div class="card qr-card no-margin-bottom">
                    <div class="card-header text-center">
                        <h2 class="card-title justify-center no-margin-bottom">
                    ...
                    <div class="card-content space-y-4">
                        ...
                        <button onclick="handleDownload()" class="btn btn-outline w-full btn-no-margin">
                        ...
                        <div class="text-center" style="font-size: 0.875rem;">
                            <p class="text-muted-foreground">
                                ...
                                <a href="{{ $link }}" target="_blank" class="qr-link-text">{{ $link }}</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid-col-sidebar space-y-6">
                ...
                <div class="card no-margin-bottom">
                    ...
                    <div class="card-content space-y-4">
                        <div class="step-item">
                            <div class="step-number"><i class="fa fa-print no-margin"></i></div>
                            <p>Print and attach your QR code to valuables.</p>
                        </div>
                        <div class="step-item">
                            <div class="step-number"><i class="fa fa-mobile no-margin"></i></div>
                            <p>If found, someone scans the code to get your report link.</p>
                        </div>
                        <div class="step-item">
                            <div class="step-number"><i class="fa fa-comments-o no-margin"></i></div>
                    ...
                    <div class="card-content space-y-4">
                        ...
                        <p class="text-muted-foreground" style="margin: 0;">
                         ...
                         <div class="quick-actions-wrapper">
                            <a href="{{ route('found') }}" class="btn btn-no-margin"><i class="fa fa-bullhorn"></i> Report Found Item</a>
                            <a href="{{ route('lostItems') }}" class="btn btn-secondary btn-no-margin"><i class="fa fa-search"></i> Browse Lost Items</a>
                        </div>
                    </div>
                </div>
            </div>
